function filterText(input) {
    ...
    // let unicalElements = [];             // 60 / 100
    //
    // for(let data of input){
    //
    //     let text = data.toLowerCase().split(/[^a-zA-Z]+/).filter(w => w != '');
    //
    //     for(let word of text){
    //         if(unicalElements.indexOf(word) == -1){
    //             unicalElements.push(word)
    //         }
    //     }
    // }
    // let output = unicalElements.join(', ');
    // console.log(output);
